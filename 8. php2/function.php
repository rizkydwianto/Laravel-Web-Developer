...
// Code function di sini
function palindrome($kataPalind) {
  $balikKata = reverseString($kataPalind);
  if($kataPalind != $balikKata) {
    echo "$kataPalind = false <br>";
  } else {
    echo "$kataPalind = true <br>";
  }
}
